...
test('GET /v1/data-item/:id?stock=in&filter=week&date=:date', async () => {
    ...
    await supertest(app)
        .get(
            '/v1/data-item/' + 1 + '?stock=in&filter=week&date=' + '2021-11-12'
        )
        .set('Authorization', 'Bearer ' + token.body.token)
        .expect(200)
        .then((res) => {
...
test('GET /v1/data-item/:id?stock=out&filter=week&date=:date', async () => {
    ...
    await supertest(app)
        .get(
            '/v1/data-item/' + 1 + '?stock=out&filter=week&date=' + '2021-11-12'
        )
        .set('Authorization', 'Bearer ' + token.body.token)
        .expect(200)
        .then((res) => {
...
test('GET /v1/data-item/:id?stock=out&filter=day&date=:date', async () => {
    ...
    await supertest(app)
        .get(
            '/v1/data-item/' + 1 + '?stock=out&filter=day&date=' + '2021-11-12'
        )
        .set('Authorization', 'Bearer ' + token.body.token)
        .expect(200)
        .then((res) => {
...
test('GET /v1/data-item/:id?stock=all&filter=week&date=:date', async () => {
    ...
    await supertest(app)
        .get(
            '/v1/data-item/' + 1 + '?stock=all&filter=week&date=' + '2021-11-12'
        )
        .set('Authorization', 'Bearer ' + token.body.token)
        .expect(200)
        .then((res) => {
...
test('GET /v1/data-item/:id?stock=all&filter=day&date=:date', async () => {
    ...
    await supertest(app)
        .get(
            '/v1/data-item/' + 1 + '?stock=all&filter=day&date=' + '2021-11-12'
        )
        .set('Authorization', 'Bearer ' + token.body.token)
        .expect(200)
        .then((res) => {
